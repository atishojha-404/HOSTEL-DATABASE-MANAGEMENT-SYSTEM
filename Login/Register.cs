...
namespace Login
{
    public partial class Register : Form
    {
        ...
        {
            if (cmbEmployeeId.Text == string.Empty)
            {
                MessageBox.Show("Employee Id is required...!!!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                cmbEmployeeId.Focus();
                return false;
            }
                ...
                if (confirm.ToString().ToUpper() == "OK")
                {
                    ...
                    using (SqlConnection con = new SqlConnection(connectionstring))
                    {
                        ...
                        if (isValiationSucess == true)
                        {
                            ...
                            cmd.CommandText = "INSERT INTO Register(EmployeeId,UserName,Password,Email,Phone,UserType) values (@EmployeeId,@UserName,@Password,@Email,@Phone,@UserType)";
                            con.Open();
